...
This guide has information to setup mediation component for development.
...
1. Make following changes to `helm-chart/templates/data-plane/gateway-components/gateway-runtime/gateway-runtime-deployment.yaml` file.
    ...
    containers:
      - name: mediation	
        image: {{ .Values.wso2.apk.dp.gatewayRuntime.deployment.mediation.image }}	
        imagePullPolicy: {{ .Values.wso2.apk.dp.gatewayRuntime.deployment.mediation.imagePullPolicy }}	
        ports:	
          - containerPort: 8081	
            protocol: "TCP"	
          - containerPort: 9001	
