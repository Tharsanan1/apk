...
// ChatCompletionContent is a string constant that represents the type of text content.
const (
...
// ChatCompletionContentPartRefusalParam Learn about
...
type ChatCompletionContentPartInputAudioParam struct {
	// InputAudio is a base64 encoded audio data.
...
// ChatCompletionContentPartInputAudioInputAudioFormat constants
const (
...
// ChatCompletionContentPartInputAudioInputAudioParam Learn about [audio inputs](https://platform.openai.com/docs/guides/audio).
...
// ChatCompletionContentPartImageImageURLDetail The detail level of the image.
type ChatCompletionContentPartImageImageURLDetail string

// ChatCompletionContentPartImageImageURLDetail constants
const (
...
// ChatCompletionContentPartImageImageURLParam Learn about
...
// UnmarshalJSON is a custom JSON unmarshaller for ChatCompletionContentPartUserUnionParam.
...
// StringOrAssistantRoleContentUnion is a custom JSON unmarshaller for
type StringOrAssistantRoleContentUnion struct {
	Value interface{}
}

// UnmarshalJSON is a custom JSON unmarshaller for StringOrAssistantRoleContentUnion.
...
// StringOrArray is a custom JSON unmarshaller for
type StringOrArray struct {
	Value interface{}
}

// UnmarshalJSON is a custom JSON unmarshaller for StringOrArray.
...
// StringOrUserRoleContentUnion is a custom JSON unmarshaller for
type StringOrUserRoleContentUnion struct {
	Value interface{}
}

// UnmarshalJSON is a custom JSON unmarshaller for StringOrUserRoleContentUnion.
...
// ChatCompletionMessageParamUnion is a custom JSON unmarshaller for
type ChatCompletionMessageParamUnion struct {
	Value interface{}
	Type  string
}

// UnmarshalJSON is a custom JSON unmarshaller for ChatCompletionMessageParamUnion.
...
// ChatCompletionToolMessageParam Messages sent by a tool, containing the result of a tool call.
...
// ChatCompletionAssistantMessageParamContentType constants
const (
...
// ChatCompletionMessageToolCallType constants
const (
...
// ChatCompletionMessageToolCallParam The tool call that the model made.
...
// ChatCompletionResponseFormatType The type of the response format.
...
// ChatCompletionResponseFormat represents the response format for the chat completion API.
...
// ChatCompletionResponseFormatJSONSchema represents the JSON schema for the response format.
...
// StreamOptions represents the options for streaming responses.
...
// ToolType represents the type of tool used in the chat completion request.
...
// Tool represents a tool that can be used in the chat completion request.
type Tool struct {
	Type     ToolType            `json:"type"`
	Function *FunctionDefinition `json:"function,omitempty"`
}

// ToolChoice represents a choice of tool to be used in the chat completion request.
...
// FunctionDefinition represents a function definition that can be called by the model.
...
// FunctionDefine is a deprecated alias for FunctionDefinition.
// Deprecated: use FunctionDefinition instead.
type FunctionDefine = FunctionDefinition

// TopLogProbs represents the most likely tokens and their log probability at a specific token position.
...
// ChatCompletionChoicesFinishReason constants
const (
...
// ChatCompletionTokenLogprobTopLogprob is described in the OpenAI API documentation:
...
// ChatCompletionTokenLogprob is described in the OpenAI API documentation:
...
// ErrorType is described in the OpenAI API documentation
